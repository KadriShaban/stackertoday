...
import styles from "./postcardopen.module.css";
import {
  ThumbUp,
  ThumbUpOutlined,
  ThumbDown,
    ...
    <div className={styles.postCardWrapper}>
      ...
      <div className={styles.postCard}>
        <div className={styles.voteContainer}>
          <button onClick={() => handleVote(1)} className={styles.voteButton}>
            {userVote === 1 ? (
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.metaInfo}>
            <span className={styles.metaItem}>
              <User size={16} className={styles.metaIcon} /> {post.displayuser}
            </span>
            <span className={styles.metaItem}>
